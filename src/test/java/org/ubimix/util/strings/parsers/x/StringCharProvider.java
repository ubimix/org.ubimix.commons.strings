...
public class StringCharProvider
    ...
    /**
     * @see org.ubimix.util.strings.parsers.x.ICharProvider#charAt(int)
     */
    ...
    /**
     * @see org.ubimix.util.strings.parsers.x.ICharProvider#length()
     */
    public int length() {
        return fLen;
    }
    ...
    /**
     * @see org.ubimix.util.strings.parsers.x.ICharProvider#subset(int,
     *      int)
     */
